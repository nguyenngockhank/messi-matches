...
eval("var baseSetToString = __webpack_require__(/*! ./_baseSetToString */ \"./node_modules/lodash/_baseSetToString.js\"),\n    shortOut = __webpack_require__(/*! ./_shortOut */ \"./node_modules/lodash/_shortOut.js\");\n\n/**\n * Sets the `toString` method of `func` to return `string`.\n *\n * @private\n * @param {Function} func The function to modify.\n * @param {Function} string The `toString` result.\n * @returns {Function} Returns `func`.\n */\nvar setToString = shortOut(baseSetToString);\n\nmodule.exports = setToString;\n\n\n//# sourceURL=webpack://football/./node_modules/lodash/_setToString.js?");
...
eval("/**\n * Creates a function that returns `value`.\n *\n * @static\n * @memberOf _\n * @since 2.4.0\n * @category Util\n * @param {*} value The value to return from the new function.\n * @returns {Function} Returns the new constant function.\n * @example\n *\n * var objects = _.times(2, _.constant({ 'a': 1 }));\n *\n * console.log(objects);\n * // => [{ 'a': 1 }, { 'a': 1 }]\n *\n * console.log(objects[0] === objects[1]);\n * // => true\n */\nfunction constant(value) {\n  return function() {\n    return value;\n  };\n}\n\nmodule.exports = constant;\n\n\n//# sourceURL=webpack://football/./node_modules/lodash/constant.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./lodash */ \"./src/frontend/lodash.js\");\n/* harmony import */ var _transformers_matchesToEvents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./transformers/matchesToEvents */ \"./src/frontend/transformers/matchesToEvents.js\");\n/* harmony import */ var _bootstrap_renderColorGoalNote__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./bootstrap/renderColorGoalNote */ \"./src/frontend/bootstrap/renderColorGoalNote.js\");\n/* harmony import */ var _bootstrap_renderMatchSelectOptions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./bootstrap/renderMatchSelectOptions */ \"./src/frontend/bootstrap/renderMatchSelectOptions.js\");\n/* harmony import */ var _bootstrap_matchFilter__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./bootstrap/matchFilter */ \"./src/frontend/bootstrap/matchFilter.js\");\n/* harmony import */ var _transformers_shouldDisplayMatch__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./transformers/shouldDisplayMatch */ \"./src/frontend/transformers/shouldDisplayMatch.js\");\n/* harmony import */ var _transformers_matchTitle__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./transformers/matchTitle */ \"./src/frontend/transformers/matchTitle.js\");\n/* harmony import */ var _transformers_isWin__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./transformers/isWin */ \"./src/frontend/transformers/isWin.js\");\n/* harmony import */ var _transformers_isDraw__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./transformers/isDraw */ \"./src/frontend/transformers/isDraw.js\");\n/* harmony import */ var _transformers_match_modal_goalContributionDetail__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./transformers/match-modal/goalContributionDetail */ \"./src/frontend/transformers/match-modal/goalContributionDetail.js\");\n\n\n\n\n\n\n\n\n\n\n\nvar events = (0,_transformers_matchesToEvents__WEBPACK_IMPORTED_MODULE_1__.matchesToEvents)();\n\nconst competitionList = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].uniq(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].map(events, (item) => item.extendedProps.competition)).sort()\nconst yearList = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].uniq(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].map(events, (item) => item.extendedProps.year)).sort()\nconst opponentList = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].uniq(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].map(events, (item) => item.extendedProps.opponent)).sort()\nconst teamList = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].uniq(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].map(events, (item) => item.extendedProps.team)).sort()\n\n;(0,_bootstrap_renderColorGoalNote__WEBPACK_IMPORTED_MODULE_2__.renderColorGoalNote)();\n(0,_bootstrap_renderMatchSelectOptions__WEBPACK_IMPORTED_MODULE_3__.renderMatchSelectOptions)('#tournamentSelect', competitionList, 'competition')\n;(0,_bootstrap_renderMatchSelectOptions__WEBPACK_IMPORTED_MODULE_3__.renderMatchSelectOptions)('#opponentSelect', opponentList, 'opponent')\n;(0,_bootstrap_renderMatchSelectOptions__WEBPACK_IMPORTED_MODULE_3__.renderMatchSelectOptions)('#teamSelect', teamList, 'team')\n;(0,_bootstrap_renderMatchSelectOptions__WEBPACK_IMPORTED_MODULE_3__.renderMatchSelectOptions)('#yearSelect', yearList, 'year')\n\n\nfunction matchHtml(match) {\n    const textClass = (0,_transformers_isWin__WEBPACK_IMPORTED_MODULE_7__.isWin)(match) ? 'text-success' : \n                     (0,_transformers_isDraw__WEBPACK_IMPORTED_MODULE_8__.isDraw)(match) ? 'text-info' : 'text-danger'\n    const title = (0,_transformers_matchTitle__WEBPACK_IMPORTED_MODULE_6__.matchTitle)(match);\n    const gaDetail = (0,_transformers_match_modal_goalContributionDetail__WEBPACK_IMPORTED_MODULE_9__.goalContributionDetail)(match);\n\n    return `<div class=\"list-group-item list-group-item-action\" aria-current=\"true\">\n    <div class=\"d-flex w-100 justify-content-between\">\n        <h5 class=\"mb-1 ${textClass}\">${title}</h5>\n        <small>${match.id}</small>\n    </div>\n    <p class=\"mb-1\">${gaDetail}</p>\n    <small>${match.competition}</small>\n  </div>`\n}\n\nwindow.eventMatches = events;\nwindow._ = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"]\n\nconst renderMatchList = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].debounce(function() {\n    const filter = (0,_bootstrap_matchFilter__WEBPACK_IMPORTED_MODULE_4__.getMatchFilter)();\n    const filteredMatches = events.filter(event => (0,_transformers_shouldDisplayMatch__WEBPACK_IMPORTED_MODULE_5__.shouldDisplayMatch)(event.extendedProps, filter));\n    // console.log(filteredMatches, filter)\n    const $container = $('#matchListGroup');\n    $container.empty();\n\n    _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].sortBy(filteredMatches, \"id\").reverse().forEach(event => {\n        $container.append(matchHtml(event.extendedProps))\n    })\n}, 100)\n\n\n;(0,_bootstrap_matchFilter__WEBPACK_IMPORTED_MODULE_4__.createMatchFilter)(() => {\n    console.log(\"filter updated\")\n    renderMatchList()\n})\n\n$('#yearSelect').val(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].last(yearList))\n$(\"#yearSelect\" ).trigger( \"change\" );\n\n//# sourceURL=webpack://football/./src/frontend/list.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/frontend/list.js");
/******/ 	
/******/ })()
;