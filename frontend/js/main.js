...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"bootstrapCalendar\": () => (/* binding */ bootstrapCalendar)\n/* harmony export */ });\n/* harmony import */ var _lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lodash */ \"./src/frontend/lodash.js\");\n/* harmony import */ var _transformers_matchesToEvents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../transformers/matchesToEvents */ \"./src/frontend/transformers/matchesToEvents.js\");\n/* harmony import */ var _data_competitionLogoMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../data/competitionLogoMap */ \"./src/frontend/data/competitionLogoMap.js\");\n/* harmony import */ var _transformers_goalContributrionBgColor__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../transformers/goalContributrionBgColor */ \"./src/frontend/transformers/goalContributrionBgColor.js\");\n/* harmony import */ var _transformers_goalContributionTitle__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../transformers/goalContributionTitle */ \"./src/frontend/transformers/goalContributionTitle.js\");\n/* harmony import */ var _transformers_match_modal_matchDetailModalTitle__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../transformers/match-modal/matchDetailModalTitle */ \"./src/frontend/transformers/match-modal/matchDetailModalTitle.js\");\n/* harmony import */ var _transformers_match_modal_matchDetailModalBody__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../transformers/match-modal/matchDetailModalBody */ \"./src/frontend/transformers/match-modal/matchDetailModalBody.js\");\n/* harmony import */ var _gaFilter__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./gaFilter */ \"./src/frontend/bootstrap/gaFilter.js\");\n\n\n\n\n\n\n\n\n\nconst displayNoneClass = 'd-none';\n\nfunction bootstrapCalendar() {\n    const $matchModal = new bootstrap.Modal(document.getElementById('matchDetail'))\n\n    document.addEventListener('DOMContentLoaded', function() {\n      var calendarEl = document.getElementById('calendar');\n  \n      var events = (0,_transformers_matchesToEvents__WEBPACK_IMPORTED_MODULE_1__.matchesToEvents)();\n      \n      const gaFilter = (0,_gaFilter__WEBPACK_IMPORTED_MODULE_7__.createGaFilter)((filter) => {\n        calendar.render();\n      })\n      \n      var calendar = new FullCalendar.Calendar(calendarEl, {\n        timeZone: 'UTC',\n        headerToolbar: {\n          left: 'prev,next today',\n          center: 'title',\n          right: 'dayGridMonth,matchesOnMonth',\n          // right: 'dayGridMonth,matchesOnYear,matchesOnMonth'\n        },\n        views: {\n          dayGridMonth: {\n            buttonText: \"Calendar\",\n          },\n          matchesOnYear: {\n            type: 'listYear',\n            buttonText: 'Year M'\n          },\n          matchesOnMonth: {\n            type: 'listMonth',\n            buttonText: 'Month Matches'\n          },\n        },\n        slotDuration: '01:30:00',\n        expandRows: true,\n        // \n        navLinks: true, \n        editable: false,\n        selectable: true,\n        weekends: true,\n        displayEventTime: false,\n        eventDisplay: 'list-item',\n        events:  events,\n        initialDate: _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].first(events).start,\n        eventOrder: \"-start\",\n        visibleRange: function(){\n          const startMatch = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].last(events);\n          const endMatch = _lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].first(events);\n          return { \n            start: new Date(startMatch.start), \n            end: new Date(endMatch.start) \n          }\n        },\n        eventDidMount: function(arg) {\n          const {event: { extendedProps: match, _def }, el} = arg;\n          $(el).css('background', (0,_transformers_goalContributrionBgColor__WEBPACK_IMPORTED_MODULE_3__.goalContributrionBgColor)(match))\n          $(el).prop('title', (0,_transformers_goalContributionTitle__WEBPACK_IMPORTED_MODULE_4__.goalContributionTitle)(match))\n          \n          addSocialIcon(el, match);\n          addCompetitionIcon(el, match);\n\n          // competitionLogoMap\n          $(el).click(() => {\n            const currentShownMatchId  = $('#matchDetail').data('match-id');\n            if (currentShownMatchId !== match.id) {\n              $('#matchDetail').data('match-id', match.id);\n              // change title\n              $('#matchDetail .modal-title').html( (0,_transformers_match_modal_matchDetailModalTitle__WEBPACK_IMPORTED_MODULE_5__.matchDetailModalTitle)(match))\n              // change body \n              $('#matchDetail .modal-body').html((0,_transformers_match_modal_matchDetailModalBody__WEBPACK_IMPORTED_MODULE_6__.matchDetailModalBody)(match));\n            }\n  \n            $matchModal.show();\n          })\n        },\n        eventClassNames: function(arg) {\n          if(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].every(gaFilter, (val) => !val)) {\n            return;\n          }\n\n          const gaDisplay = Object.keys(_lodash__WEBPACK_IMPORTED_MODULE_0__[\"default\"].pickBy(gaFilter, v => v)).map(v => Number(v))\n          if (!gaDisplay || gaDisplay.length === 0) {\n            return;\n          }\n          \n          const { event: { extendedProps: { goals, assists} }} = arg;\n          const match = gaDisplay.includes(goals) || gaDisplay.includes(assists)\n          if (match) {\n            return;\n          }\n          return displayNoneClass\n        }\n      });\n\n      calendar.render();\n    });\n}\n\nfunction addSocialIcon(el, match) {\n  if (match.tweets || match.videos) {\n    const $el = $(el).find('.fc-event-title');\n    // $el.addClass('event-prefix').removeClass('fc-daygrid-event-dot');\n    // const $el = $(el)\n    if (match.videos) {\n      $el.append(`<i class=\"bi bi-youtube\"></i>`)\n    }\n    if (match.tweets) {\n      $el.append(`<i class=\"bi bi-twitter\"></i>`)\n    }\n  }\n}\n\nfunction addCompetitionIcon(el, match) {\n  const { competition } = match;\n  const logo = _data_competitionLogoMap__WEBPACK_IMPORTED_MODULE_2__.competitionLogoMap[competition]\n  logo && $(el).find('.fc-event-title').prepend(`<span class=\"comp-container\"><img class=\"comp-icon\" title=\"${competition}\" src=\"./img/${logo}\"/></span>`)\n}\n\n//# sourceURL=webpack://football/./src/frontend/bootstrap/bootstrapCalendar.js?");

/***/ }),

/***/ "./src/frontend/bootstrap/drawColorGoalNote.js":
/*!*****************************************************!*\
  !*** ./src/frontend/bootstrap/drawColorGoalNote.js ***!
  \*****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"drawColorGoalNote\": () => (/* binding */ drawColorGoalNote)\n/* harmony export */ });\n/* harmony import */ var _data_static__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../data/static */ \"./src/frontend/data/static.js\");\n/* harmony import */ var _gaFilter__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./gaFilter */ \"./src/frontend/bootstrap/gaFilter.js\");\n\n\n\nconst activeClass = 'border-info border';\n\nfunction drawColorGoalNote() {\n  for (const count in _data_static__WEBPACK_IMPORTED_MODULE_0__.gaColorMap) {\n    $('.note').append(`<span class=\"ga-selector\" style=\"background-color: ${_data_static__WEBPACK_IMPORTED_MODULE_0__.gaColorMap[count]}\">${count}</span>`);\n  }\n\n  $('.note .ga-selector').click(function(){\n    const $el = $(this);\n    const counter = $el.html();\n    $el.toggleClass(activeClass);\n    const active = $el.hasClass(activeClass);\n\n    const gaFilter = (0,_gaFilter__WEBPACK_IMPORTED_MODULE_1__.getGaFilter)();\n    gaFilter[counter] = active;\n  })\n}\n\n\n//# sourceURL=webpack://football/./src/frontend/bootstrap/drawColorGoalNote.js?");

/***/ }),

/***/ "./src/frontend/bootstrap/gaFilter.js":
/*!********************************************!*\
  !*** ./src/frontend/bootstrap/gaFilter.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"createGaFilter\": () => (/* binding */ createGaFilter),\n/* harmony export */   \"getGaFilter\": () => (/* binding */ getGaFilter)\n/* harmony export */ });\n\nlet gaFilter = null;\n\nfunction createGaFilter(callback) {\n    if (gaFilter) {\n        return gaFilter;\n    }\n\n    const gaFilterObj = {};\n    gaFilter = new Proxy(gaFilterObj, {\n        set: function (target, key, value) {\n            target[key] = value;\n            callback(target);\n            return true;\n        }\n    });\n    return gaFilter;\n}\n\nfunction getGaFilter() {\n    return gaFilter;\n}\n\n//# sourceURL=webpack://football/./src/frontend/bootstrap/gaFilter.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _bootstrap_bootstrapCalendar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./bootstrap/bootstrapCalendar */ \"./src/frontend/bootstrap/bootstrapCalendar.js\");\n/* harmony import */ var _bootstrap_drawColorGoalNote__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./bootstrap/drawColorGoalNote */ \"./src/frontend/bootstrap/drawColorGoalNote.js\");\n\n\n\n(0,_bootstrap_drawColorGoalNote__WEBPACK_IMPORTED_MODULE_1__.drawColorGoalNote)();\n(0,_bootstrap_bootstrapCalendar__WEBPACK_IMPORTED_MODULE_0__.bootstrapCalendar)();\n\n//# sourceURL=webpack://football/./src/frontend/index.js?");
