...
export interface PlayerEvents {
    events:           Event[];
    hasNextPage:      boolean;
    playedForTeamMap: { [key: string]: number };
    statisticsMap:    { [key: string]: StatisticsMap };
    incidentsMap:     { [key: string]: IncidentsMap };
    onBenchMap:       { [key: string]: boolean };
}
...
export enum UniqueTournamentName {
...
export enum UniqueTournamentSlug {
    ClubFriendlyGames = "club-friendly-games",
    ClubWorldChampionship = "club-world-championship",
    ConmebolUefaCupOfChampions = "conmebol-uefa-cup-of-champions",
